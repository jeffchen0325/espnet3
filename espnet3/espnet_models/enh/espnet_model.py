...
from espnet3.espnet_models.enh.loss.criterions.tf_domain import FrequencyDomainLoss
from espnet3.espnet_models.enh.loss.criterions.time_domain import TimeDomainLoss
