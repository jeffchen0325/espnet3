...
from espnet3.legacy.nets.pytorch_backend.conformer.convolution import ConvolutionModule
from espnet3.legacy.nets.pytorch_backend.conformer.encoder_layer import EncoderLayer
from espnet3.legacy.nets.pytorch_backend.nets_utils import get_activation, make_pad_mask
...
from espnet3.legacy.nets.pytorch_backend.transformer.multi_layer_conv import (
    Conv1dLinear,
    MultiLayeredConv1d,
)
...
from espnet3.legacy.nets.pytorch_backend.transformer.repeat import repeat
from espnet3.legacy.nets.pytorch_backend.transformer.subsampling import (
    Conv2dSubsampling,
    Conv2dSubsampling1,
    Conv2dSubsampling2,
    Conv2dSubsampling6,
...
class LongformerEncoder(ConformerEncoder):
    ...
    def __init__(
        ...
        if selfattention_layer_type == "lf_selfattn":
            ...
            from espnet3.legacy.nets.pytorch_backend.transformer.longformer_attention import (  # noqa: E501
                LongformerAttention,
            )
