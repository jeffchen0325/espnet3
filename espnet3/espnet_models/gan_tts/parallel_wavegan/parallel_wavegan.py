...
from espnet3.espnet_models.gan_tts.parallel_wavegan import upsample
from espnet3.espnet_models.gan_tts.wavenet.residual_block import Conv1d, Conv1d1x1, ResidualBlock
