...
from espnet3.espnet_models.gan_tts.vits.duration_predictor import StochasticDurationPredictor
...
from espnet3.espnet_models.gan_tts.vits.text_encoder import TextEncoder
...
class VITSGenerator(torch.nn.Module):
    ...
    def __init__(
        ...
        # delayed import
        from espnet3.espnet_models.gan_tts.vits.monotonic_align import maximum_path
