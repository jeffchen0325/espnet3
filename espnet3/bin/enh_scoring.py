...
from espnet3.train.dataset import kaldi_loader
...
def scoring(
    ...
    if use_dnsmos:
        if dnsmos_args["mode"] == "local":
            from espnet3.espnet_models.enh.layers.dnsmos import DNSMOS_local
            ...
            from espnet3.espnet_models.enh.layers.dnsmos import DNSMOS_web
