...
from espnet3.models.asr.decoder.hugging_face_transformers_decoder import (
    get_hugging_face_model_lm_head,
    get_hugging_face_model_network,
)
from espnet3.models.asr.decoder.s4_decoder import S4Decoder
from espnet3.models.asr.partially_AR_model import PartiallyARInference
from espnet3.models.asr.transducer.beam_search_transducer import (
    BeamSearchTransducer,
)
from espnet3.models.asr.transducer.beam_search_transducer import (
    ExtendedHypothesis as ExtTransHypothesis,
)
from espnet3.models.asr.transducer.beam_search_transducer import Hypothesis as TransHypothesis
...
from espnet3.legacy.nets.beam_search_timesync import BeamSearchTimeSync
from espnet3.legacy.nets.pytorch_backend.transformer.subsampling import TooShortUttError
from espnet3.legacy.nets.scorer_interface import BatchScorerInterface
from espnet3.legacy.nets.scorers.ctc import CTCPrefixScorer
from espnet3.legacy.nets.scorers.length_bonus import LengthBonus
    ...
    def __init__(
        ...
        if ngram_file is not None:
            if ngram_scorer == "full":
                from espnet3.legacy.nets.scorers.ngram import NgramFullScorer

                ngram = NgramFullScorer(ngram_file, token_list)
            else:
                from espnet3.legacy.nets.scorers.ngram import NgramPartScorer
